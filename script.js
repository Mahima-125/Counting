...
const objects = [
  { name: "Stars", count: 8, image: "../images/star.png", options: [2, 3, 8, 5] },
  { name: "Balls", count: 6, image: "../images/ball.png", options: [1, 6, 4, 8] },
  { name: "Butterflies", count: 10, image: "../images/butterfly.png", options: [5, 7, 10, 8] },
  { name: "Flowers", count: 7, image: "../images/flower.png", options: [3, 5, 7, 8] },
  { name: "Rainbows", count: 4, image: "../images/rainbow.png", options: [3, 4, 6, 7] }
];
